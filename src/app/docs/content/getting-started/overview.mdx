...
### GradSync aims to integrate data from various sources to gain valuable insights. We employ a robust ETL (Extract, Transform, Load) pipeline to process data from different formats and sources, clean and merge it, and store it in optimized database systems for further analysis.
<br />
### ETL Pipeline
